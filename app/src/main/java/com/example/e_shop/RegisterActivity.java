...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText user_nameedittext, emailedittext, passwordedittext,phonenoedittext,addressedittext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phonenoedittext = findViewById(R.id.editTextPhone);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (phoneno.isEmpty())
                {
                    phonenoedittext.setError("Enter your phone no.");
                ...
                register(user_name,email,phoneno,address,password);
            }
        });
    }

    public void register (final String user_name , final String email , final String phoneno, final String address , String password)
    {
